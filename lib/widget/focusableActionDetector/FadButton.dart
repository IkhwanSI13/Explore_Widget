...
class FadButtonActivity extends StatefulWidget {

  @override
  State<FadButtonActivity> createState() => _FadButtonActivityState();
}

class _FadButtonActivityState extends State<FadButtonActivity> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
